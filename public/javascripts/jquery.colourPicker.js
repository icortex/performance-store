	...
	return this.each(function () {
		...
		icon.click(function () {
			...
			jQuery('a', colourPicker).click(function () {
				...
				// If user wants to, change the input's BG to reHideflect the newly selected colour
				if (config.inputBG) {
