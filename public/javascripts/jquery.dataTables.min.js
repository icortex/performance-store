...
(function(j, ra, p) {
    ...
    n.oPagination = {two_button:{fnInit:function(g, m, r) {
        ...
        var s = p.createElement("span"),w = p.createElement("span"),y = p.createElement("span"),F = p.createElement("span"),x = p.createElement("span");
        ...
        if (g.aanFeatures.p) {
            var r = n.oPagination.iFullNumbersShowPages,s = Math.floor(r / 2),w = Math.ceil(g.fnRecordsDisplay() / g._iDisplayLength),y = Math.ceil(g._iDisplayStart / g._iDisplayLength) + 1,F = "",x,u = g.oClasses;
            if (w < r) {
                s = 1;
                x = w
            } else if (y <= s) {
    ...
    j.fn.dataTable = function(g) {
        function m() {
            ...
            this.aanFeatures = [];
            this.oLanguage = {sProcessing:"Processing...",sLengthMenu:"Mostrar _MENU_ entradas",sZeroRecords:"No hay coincidencias",sEmptyTable:"No hay informacion disponible en la tabla",sInfo:"Mostrando _START_ a _END_ de _TOTAL_ entradas",sInfoEmpty:"Mostrando 0 a 0 de 0 entradas",sInfoFiltered:"(filtrado de _MAX_ entradas totales)",sInfoPostFix:"",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primera",sPrevious:"Anterior",sNext:"Siguiente",sLast:"Ultima"},fnInfoCallback:null};
            this.aoData = [];
            this.aiDisplay = [];
        ...
        function s(a) {
            ...
            if (a.bInitialised === false)setTimeout(function() {
                ...
                b = 0;
                for (c = a.aoColumns.length; b < c; b++)if (a.aoColumns[b].sWidth !== null)a.aoColumns[b].nTh.style.width = v(a.aoColumns[b].sWidth);
        ...
        function F(a, b) {
            ...
            if (typeof a.aoPreSearchCols[b] ==
                    "undefined" || a.aoPreSearchCols[b] === null)a.aoPreSearchCols[b] = {sSearch:"",bRegex:false,bSmart:true}; else {
        ...
        function ta(a) {
            if (a.bAjaxDataGet) {
                ...
                if (a.oFeatures.bSort !== false) {
                    ...
                    for (d = 0; d < b; d++)c.push({name:"bSortable_" +
        ...
        function za(a) {
            ...
            var b = p.createElement("div"),c = p.createElement("div"),d = p.createElement("div"),f = p.createElement("div"),e = p.createElement("div"),i = p.createElement("div"),h = a.nTable.cloneNode(false),k = a.nTable.cloneNode(false),l = a.nTable.getElementsByTagName("thead")[0],q = a.nTable.getElementsByTagName("tfoot").length ===
                    0 ? null : a.nTable.getElementsByTagName("tfoot")[0],t = typeof g.bJQueryUI != "undefined" && g.bJQueryUI ? n.oJUIClasses : n.oStdClasses;
            c.appendChild(d);
            e.appendChild(i);
            ...
            a.aoDrawCallback.push({fn:Ca,sName:"scrolling"});
        ...
        function Ca(a) {
            var b = a.nScrollHead.getElementsByTagName("div")[0],c = b.getElementsByTagName("table")[0],
                    d = a.nTable.parentNode,f,e,i,h,k,l,q,t,G = [];
        ...
        function Aa(a) {
            ...
            if (typeof a.aanFeatures.i == "undefined") {
                a.aoDrawCallback.push({fn:Ga,sName:"information"});
        ...
        this.fnUpdate = function(a, b, c, d, f) {
            var e = A(this[n.iApiIndex]),i,h;
            b = typeof b == "object" ? Q(e, b) : b;
            if (typeof a != "object") {
                h = a;
                e.aoData[b]._aData[c] = h;
                if (e.aoColumns[c].fnRender !== null) {
                    h = e.aoColumns[c].fnRender({iDataRow:b,iDataColumn:c,aData:e.aoData[b]._aData,oSettings:e});
                    if (e.aoColumns[c].bUseRendered)e.aoData[b]._aData[c] = h
                }
                i = M(e, c);
                if (i !== null)e.aoData[b].nTr.getElementsByTagName("td")[i].innerHTML = h; else e.aoData[b]._anHidden[c].innerHTML = h
            } else {
                if (a.length !=
                        e.aoColumns.length) {
                ...
                for (c = 0; c < a.length; c++) {
                    ...
                    i = M(e, c);
                    if (i !== null)e.aoData[b].nTr.getElementsByTagName("td")[i].innerHTML = h; else e.aoData[b]._anHidden[c].innerHTML =
                            h
                }
            }
        ...
        return this.each(function() {
            ...
            for (b = D.length; a < b; a++) {
                if (D[a].nTable == this)if (typeof g == "undefined" || typeof g.bRetrieve !=
                        "undefined" && g.bRetrieve === true)return D[a].oInstance; else if (typeof g.bDestroy != "undefined" && g.bDestroy === true) {
            ...
            if (this.nodeName.toLowerCase() != "table")H(e, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName); else {
                ...
                if (h)for (a = 0; a < g.aaData.length; a++)u(e, g.aaData[a]); else z(e);
